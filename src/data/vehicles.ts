...
export const VEHICLES_DATA: VehicleData[] = [
  ...
  },
  {
    ...
    description:
      "SUV sportif au caractère affirmé : 420 ch, boîte automatique, intérieur cuir noir et rouge avec pack Sport Chrono. Idéal pour allier confort, espace et plaisir de conduite en Suisse romande.",
    video: "",
    images: [
      "/porsche-macan-1.png",
      "/porsche-macan-2.png",
    ...
    specs: {
      ...
      interiorColor: "Cuir noir / surpiqûres rouges",
      kilometers: "—",
      warranty: "—",
    },
    pricing: [
      { duration: "24 heures (Tarif journalier)", km: "200 km", price: "590 CHF" },
      { duration: "Week-end court (Vendredi – Dimanche)", km: "400 km", price: "990 CHF" },
      { duration: "Week-end long (Vendredi – Lundi)", km: "600 km", price: "1'390 CHF" },
      { duration: "Semaine courte (Lundi – Vendredi, 5 jours)", km: "1'000 km", price: "2'050 CHF" },
      { duration: "Semaine complète (7 jours)", km: "1'400 km", price: "2'800 CHF" },
    ],
    brand: "Porsche",
    model: "Macan Turbo",
    pricePerDay: 590,
